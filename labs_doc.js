...
<span class="lab-keyword">system_prompt:</span> |
  ...
  <span class="lab-string">&lt;guidelines&gt;</span>
    ...
    2. Antes de criar a modelagem de dados, use a tool <code>read_confluence</code> e busque pela página "Regras de Máscara de Dados LGPD".
    3. Sua saída DEVE sempre conter um Diagrama Mermaid na sintaxe <code>graph TD</code>.
